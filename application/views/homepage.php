...
<script type="text/javascript" src="<?php echo base_url('assets/web/js/bootstrap.js');?>"></script>
...
<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/web/fonts/css/font-awesome.min.css');?>">
<script type="text/javascript" src="<?php echo base_url('assets/web/js/modernizr.custom.28468.js');?>"></script>
<script type="text/javascript" src="<?php echo base_url('assets/web/js/jquery.cslider.js');?>"></script>
...
<div class="main_bg"><!-- start main -->
	<div class="container">
		<div class="main row">
			...
			<button type="button" class="btn btn-success btn-lg" data-toggle="modal" data-target="#myModal">Detail</button>
		...
		<!-- Modal Kedua -->
			...
			<div class="col-md-3 images_1_of_4 bg1 text-center">
				...
				<button type="button" class="btn btn-success btn-lg" data-toggle="modal" data-target="#myModal1">Detail</button>
		...
		<button type="button" class="btn btn-success btn-lg" data-toggle="modal" data-target="#myModal2">Detail</button>
			...
			<button type="button" class="btn btn-success btn-lg" data-toggle="modal" data-target="#myModal3">Detail</button>
			...
			<div class="col-md-6 content_right">
				...
				<!----start-img-cursual---->
					<div id="owl-demo" class="owl-carousel text-center">
						<div class="item">
							<div class="cau_left">
								<img class="lazyOwl" src="<?php echo base_url('assets/web/images/c1.jpg');?>" alt="Lazy Owl Image">
							</div>
							<div class="cau_left">
						...
						<div class="item">
							<div class="cau_left">
								<img class="lazyOwl" src="<?php echo base_url('assets/web/images/c2.jpg');?>" alt="Lazy Owl Image">
							</div>
							<div class="cau_left">
						...
						<div class="item">
							<div class="cau_left">
								<img class="lazyOwl" src="<?php echo base_url('assets/web/images/c3.jpg');?>" alt="Lazy Owl Image">
							</div>
							<div class="cau_left">
						...
						<div class="item">
							<div class="cau_left">
								<img class="lazyOwl" src="<?php echo base_url('assets/web/images/c4.jpg');?>" alt="Lazy Owl Image">
							</div>
							<div class="cau_left">
...
<div class="footer_bg"><!-- start footer -->
	<div class="container">
<div class="row h_menu">
<div class="soc_icons navbar-center">
