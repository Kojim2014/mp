...
<body>
 ...
 <div class="wow rollIn">
  ...
  <div class="section section_perjalanan wow flipInX">
    <div class="wrapper" style="margin:4%;">

        <h4><span>Perjalanan</span></h4>

      <div class="col-sm-5 col-md-3">
        <div class="thumbnail">
          <img src="<?php echo base_url('assets/asset/cover/php-oop.png');?>" data-holder-rendered="true" style="height: 200px; width: 100%; display: block;">
          <div class="caption">
            <h3>Thumbnail label</h3>
            <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
            <p><a href="#popup" class="btn btn-primary" role="button">Button</a></p>
          </div>
        </div>
        <div id="closed"></div>
      ...
      <div class="col-sm-5 col-md-3">
        <div class="thumbnail">
          ...
          <div class="caption">
            <h3>Thumbnail label</h3>
            <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
            <p><a href="#popup1" class="btn btn-primary" role="button">Button</a></p>
              </div>
          </div>
<div id="closed"></div>
              <div class="popup-wrapper" id="popup1">
                <div class="popup-container">
                    ...
                    <h2>Ikuti Update !!</h2>
                    <p>Daripada hanya melihaaaaaaaaaaaaaaat demo untuk popup-nya saja, lebih baik masukkan juga email anda agar mendapatkan pemberitahuan saat ada update posting menarik lain seperti ini.<br/>
                    <strong>Percayalah, saya hanya akan mengirim sesuatu yang bermanfaat untuk anda :)</strong></p>
                    <a class="popup-close" href="#akdmik">X</a>
      ...
      <div class="col-sm-5 col-md-3">
        <div class="thumbnail">
          ...
          <div class="caption">
            <h3>Thumbnail label</h3>
            <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
            <p><a href="#popup2" class="btn btn-primary" role="button">Button</a></p>
          </div>
        </div>
        <div id="closed"></div>
              <div class="popup-wrapper" id="popup2">
                <div class="popup-container">
                    ...
                    <h2>Ikuti Update !!</h2>
                    <p>Daripada hanya melihat deeeeeeeeeeeeeeeemo untuk popup-nya saja, lebih baik masukkan juga email anda agar mendapatkan pemberitahuan saat ada update posting menarik lain seperti ini.<br/>
                    <strong>Percayalah, saya hanya akan mengirim sesuatu yang bermanfaat untuk anda :)</strong></p>
                    <a class="popup-close" href="#akdmik">X</a>
...
Luaskan ilmu, luaskan manfaat.</p>
        ...
        <div id="footer_last">
          <div id="copyright">&copy;Media Pembelajaran 2016</div>
        </div>
